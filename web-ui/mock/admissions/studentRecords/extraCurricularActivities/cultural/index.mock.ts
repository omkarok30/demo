...
const mockMethods = [
  {
    url: "/:api?/:tenant?/v1/admissions/student_record/extra-curricular/cultural/list",
    method: "GET",
    body() {
      return {
        code: 200,
  ...
  {
    url: "/:api?/:tenant?/v1/admissions/student_record/extra-curricular/cultural/get/:id?",
    method: "GET",
    body({ params }) {
