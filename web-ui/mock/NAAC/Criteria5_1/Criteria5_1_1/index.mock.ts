...
const mockMethods = [
  {
    url: '/:api?/:tenant?/v1/NAAC/criteria5/5.1.1/government/list/:year',
    method: 'GET',
    body({ params }) {
  ...
  {
    url: '/:api?/:tenant?/v1/NAAC/criteria5/5.1.1/Government/scholar/get/:year',
    method: 'GET',
    body({ params }) {
  ...
  {
    url: '/:api?/:tenant?/v1/NAAC/criteria5/5.1.1/Government/students/get/:year',
    method: 'GET',
    body({ params }) {
