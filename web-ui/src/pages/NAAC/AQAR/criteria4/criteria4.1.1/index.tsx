  ...
  return (
    <div className='layout-main-content'>
      ...
      <Card>
        ...
        <EditorApp
          title="
            Describe the adequacy of infrastructure and physical facilities for teaching–learning as per the minimum specified requirement by statutory bodies:"
          criteriaNumber="4.1.1"
          assessmentType="aqar"
          year={selectYear}
          characterLimit="100"
        ></EditorApp>
...
export default NACCCAQARFourOneOne;
