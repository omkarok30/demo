...
function NACCCAQARFourFourTwo() {
  const mainTitle = '4.4. Maintenance of Campus Infrastructure';
  const subTitle
    ...
    <div className='layout-main-content'>
      <h2>{mainTitle}</h2>
        ...
        <Divider />
          ...
          <EditorApp
            title="Describe policy details of systems and procedures for maintaining and utilizing physical, academic and support facilities on the website within a maximum of 200 words:"
            criteriaNumber="4.4.2"
            assessmentType="aqar"
            year={selectYear}
            characterLimit="100"
          ></EditorApp>
...
export default NACCCAQARFourFourTwo;
