...
import { useNaacStudent23 } from '@/store/NAAC/ExtendedProfile/student/useNaacStudent_2_3';
...
export const useCustomDataHook = () => {
  ...
  const { studRecordsCounts, getAllStudentsRecords } = useNaacStudent23((state: any) => ({
...
export const useStudentCourseHook = (yearId) => {
  ...
  const { current, studentsData, getStudentsRecord, getAllStudentsRecords } = useNaacStudent23((state: any) => ({
