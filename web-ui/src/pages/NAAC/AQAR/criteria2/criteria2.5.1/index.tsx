...
function NACCAQARTwoFiveOne() {
  const mainTitle = '2.5. Evaluation Process and Reforms';
  const subTitle
    ...
    <div className='layout-main-content'>
      ...
      <Card>
        ...
        <EditorApp
          ...
          title="Description"
        ></EditorApp>
        <FileDescriptionList criteria="2.5.1" title={subTitle} year={selectYear}></FileDescriptionList>
        <Review criteria="2.5.1" reviewType="Internal" title={subTitle} year={selectYear}></Review>
        <Review criteria="2.5.1" reviewType="External" title={subTitle} year={selectYear}></Review>
      </Card>
    </div>
  );
}

export default NACCAQARTwoFiveOne;
