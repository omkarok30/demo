...
const NACCAQARTwoThreeOne = () => {
  ...
  useEffect(() => {
    storeFileDescription.getRecords('2.3.1.');
    ...
    <div className='layout-main-content'>
      ...
      <Card>
        ...
        <EditorApp
          ...
          title="Description:"
        ></EditorApp>
        <FileDescriptionList criteria="2.3.1" title={subTitle} year={selectYear}></FileDescriptionList>
        <Review criteria="2.3.1" reviewType="Internal" title={subTitle} year={selectYear}></Review>
        <Review criteria="2.3.1" reviewType="External" title={subTitle} year={selectYear}></Review>
      </Card>
    </div>
  );
};

export default NACCAQARTwoThreeOne;
