    ...
    return (
        <div>
            <Form form={form} layout="vertical" >
                <Form.Item name="Termination/Removal Date" label="Termination/Removal Date" required style={{ flex: 1, marginRight: 10, fontWeight: 'bold' }}>
                <DatePicker className="w-100%" format={global.displayDateFormat} placeholder={'PLEASE SELECT FROM CALENDAR'} />
                </Form.Item>
                <Form.Item name="Reason for Termination/Removal" label="Reason for Termination/Removal"  style={{ flex: 1, marginRight: 10, fontWeight: 'bold', marginTop: 20 }}>
                    <Input.TextArea style={{ textTransform: 'uppercase' }} rows={3} />
                </Form.Item>
                <Form.Item name="Termination/Removal Letter" label="Termination/Removal Letter" getValueFromEvent={getFile} style={{ flex: 1, marginRight: 10, fontWeight: 'bold' }}>
                    <Upload>
