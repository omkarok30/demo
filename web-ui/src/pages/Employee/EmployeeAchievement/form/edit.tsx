...
const EmployeeAchievementFormEdit = () => {
  ...
  const headerLabel = isNew ? 'Add Achievement' : 'Update Achievement';
            ...
            <Col className='w-md'>
              <When condition={!isNew}>
                {() => (<>
                  ...
                  <Form.Item name="achievement" label="Achievement" required rules={schemaRules} style={{ flex: 1, marginRight: 10,fontWeight:'bold'  }}>
                    <Input style={{ textTransform: 'uppercase' }} />
                  </Form.Item>
                  <Form.Item name="details" label="Details" rules={schemaRules} required style={{ flex: 1, marginRight: 10 ,fontWeight:'bold' }}>
                    <Input.TextArea style={{ textTransform: 'uppercase' }} rows={3} />
                  </Form.Item>
                  <Form.Item rules={schemaRules} name="document" label="Upload Document" getValueFromEvent={getFile} style={{ flex: 1, marginRight: 10 ,fontWeight:'bold' }}>
                    <Upload>
