...
const QualificationDetailsFormPGEdit = (props) => {
            ...
            <When condition={!isNew}>
                {() => (<>
                    <Form form={form} layout="vertical" disabled={saveProgress.disableForm}>
                        <Form.Item name="degree" label="Degree" rules={schemaRules} required style={{ flex: 1, marginRight: 10, fontWeight: 'bold' }}>
                            <Input style={{ textTransform: 'uppercase' }} placeholder='FOR EXAMPLE: BE/B.TECH' />
                        </Form.Item>
...
export default QualificationDetailsFormPGEdit;
