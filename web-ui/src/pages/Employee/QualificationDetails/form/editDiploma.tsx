...
const QualificationDetailsFormDiplomaEdit = (props) => {
    ...
    return (
        <div>
            ...
            <Form.Item>
                ...
                {isNew ? <Button type="default" disabled={saveProgress.disableSubmit} loading={saveProgress.saving}>
                    Reset
                </Button>
                    :
                    <Button type="default" onClick={nvaigateToPreviousPage} disabled={saveProgress.disableSubmit} loading={saveProgress.saving}>
                        Back
                    </Button>
                }
            </Form.Item>
...
export default QualificationDetailsFormDiplomaEdit;
