...
const QualificationDetailsFormPhdEdit = (props) => {
            ...
            <When condition={!isNew}>
                {() => (<>
                    <Form form={form} layout="vertical" disabled={saveProgress.disableForm}>
                        ...
                        <Form.Item name="registrationYear" label="Year of Registration" rules={schemaRules} required style={{ flex: 1, marginRight: 10, fontWeight: 'bold' }}>
                            <Input style={{ textTransform: 'uppercase' }} placeholder='FOR EXAMPLE: 2012' />
                        </Form.Item>
...
export default QualificationDetailsFormPhdEdit;
