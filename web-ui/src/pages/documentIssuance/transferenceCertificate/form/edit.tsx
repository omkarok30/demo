...
const EditTransferCertificate = () => {
  const { id, type, migration_status,program} = useParams();
  const isNew = id === "new";
  ...
  const headerLabel =
    migration_status === "1"
      ...
      : "Issue Transference Certificate";
  console.log("test", id, type);

  React.useEffect(() => {
    storeTransferenceCertificate.getRecord(id);    
    storeProgramDetails.getProgramsRecord(program?.slice(-1))
        ...
        <Row className="justify-center">
          <Col span={12}>
            <Form form={form} layout="vertical" autoComplete="off">
              ...
              >
                <TextArea disabled style={{ textTransform: "uppercase" }}/>
              </Form.Item>
              <Form.Item
                style={{ fontWeight: "bold" }}
                name="conduct"
...
export default EditTransferCertificate;
