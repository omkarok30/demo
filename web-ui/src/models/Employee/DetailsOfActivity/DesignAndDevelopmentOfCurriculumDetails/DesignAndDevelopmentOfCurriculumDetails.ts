...
export const allColumns = {
  ...
  considerForAccrediation: { type: 'string', db: 'consider_for_accrediation' },
...
export const schemaRules = yup.object().shape({
  ...
  considerForAccrediation:yup.string().required('required'),
});
...
export const columns = (settings: any) => {
  const cols: ColumnsType<any> = [
    ...
    { dataIndex: 'programId', title: 'Name of Program',responsive: ['md'], },
    { dataIndex: 'courseName', title: 'Course Name',responsive: ['md'],},
    { dataIndex: 'considerForAccrediation', title: 'Consider for Accreditation?',responsive: ['md'],},
