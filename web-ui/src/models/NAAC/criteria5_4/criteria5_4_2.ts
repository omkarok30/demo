...
export const allColumns = {
  ...
  contribution: { type: 'string', db: 'contribution' },
};
...
export const columns = (settings: any) => {
  const cols: ColumnsType<any> = [
    ...
    { dataIndex: 'contribution', key: 'contribution', title: 'Alumni Contribution (INR in Lakhs)', width: 300 },
  ];
  return cols;
};
...
export const submitJSON = (values: any, modelOnly = true) => {
  ...
  return JSON.stringify({ NAACCriteria542: { ...data } });
};
