...
export const columns = (settings: any) => {
  const cols: ColumnsType<any> = [
    ...
    { dataIndex: 'studentBeneiciaryDetails$count', title: 'Number of students benefited by scholarships, freeships etc. provided by the institution / non-government agencies', width: 300 },
    { dataIndex: 'studentPromotionMap$count', title: 'Total number of students', width: 300 },
  ];
  return cols;
};
...
export const submitJSON = (values: any, modelOnly = true) => {
  ...
  return JSON.stringify({ NAACCriteria512: { ...data } });
};
