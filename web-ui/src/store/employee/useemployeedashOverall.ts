...
import * as service from '@/services/employees/employeeDashOverall';
...
const store = (set: any, get: any) => ({
  ...
  getRecords: async () => {
    try {
      ...
      set({ allRecords: records ,activeToolsRecord: activeTools, inactiveToolsRecord: inactiveTools });
    }
    catch (e) { }
  },
  ...
  getRecord: async (id = 'new') => {
    ...
    const res = await service.getEmployeeDashboardOverall(id);
...
export const useEmployeeDashboardoverall = create(devstore);
